...
def Defumado():
    ...
    txtGolem2 = Texto(floresta, "Irei atrÃÂ¡s da caÃÂ§a para me alimentar, talvez na cidade!")
    ...
    Golem3.entra(berlim)
    txtGolem3 = Texto(berlim, "A cidade irÃÂ¡ ficar diante dos meus pÃÂ©s!")
    ...
    Mago.entra(Mistica)
    txtMago=Texto(Mistica, "Onde andas minha criaÃÂ§ÃÂ£o?")
    ...
    txtAmiguinho=Texto(berlim2, "Quem hÃÂ¡ de entrar em minha morada? Yo soy Dollynho!")
    ...
    txtGolem4 = Texto(berlim3, "Essa cidade ÃÂ© pequena demais pra nois dois, meu brodi!")
    ...
    txtAmiguinho2=Texto(berlim4, "Veremos ver quem irÃÂ¡ ficar com o territÃÂ³rio!")
