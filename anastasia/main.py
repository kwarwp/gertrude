...
# ConfiguraÃ§Ã£o da largura e altura da cena
STYLE["width"] = 1000
STYLE["height"] = "600px"

# Criando um dicionÃ¡rio com as imagens
IMG = {
...
class Lago:
	# ConstrÃ³i a cena com os objetos e as aÃ§Ãµes de cada objeto
	def __init__(self):

		# Inicia o inventÃ¡rio
		INVENTARIO.inicia();
        
		# Cria a cena
		self.__lago = Cena(img = IMG['background']);
        
		# Cria os objetos da cena juntamente com suas aÃ§Ãµes
	...
	# Coloca a moeda piscante no inventÃ¡rio
	def __vaiMoedaPiscante(self, _=0): INVENTARIO.bota(self.__moedaPiscante)      

	# Coloca a moeda normal no inventÃ¡rio
