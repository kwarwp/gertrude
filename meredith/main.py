...
from danae.main import Guarita1
...
IMG = {
	'background1': 'http://ebendinger.jbrj.gov.br/fotos/75.jpg',
...
class Aleia1:
	...
	def __init__(self):
		...
		# Cria a cena
		self.__aleia1 = Cena(img = IMG['background1']);
		...
		# Adicionando a Cena
		self.__passarinho.entra(self.__aleia1);
		self.__ninho.entra(self.__aleia1);
		seta.entra(self.__aleia1);
	...
	# Executa a cena
	def vai(self, *_): self.__aleia1.vai()
...
class Aleia2:
	...
	def __init__(self):
		...
		# Criando elementos
		self.__aleia2 = Cena(img = IMG['background2']);
...
class Aleia3:
	...
	def __init__(self):
		...
		# Criando elementos
		self.__aleia3 = Cena(img = IMG['background3']);
