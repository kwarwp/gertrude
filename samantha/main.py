...
class Menu:
	...
	def __init__(self):
		...
		lekes.vai=Texto(self.__menu ,"AndrÃÂÃÂÃÂÃÂ©- Cara, vocÃÂÃÂÃÂÃÂª ouviu que o Jardim BotÃÂÃÂÃÂÃÂ¢nico estÃÂÃÂÃÂÃÂ¡ em manutenÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£o?    Matheus- Sim, fiquei sabendo que coisas estranhas vem acontecendo lÃÂÃÂÃÂÃÂ¡!").vai
		nana.vai=Texto(self.__menu,"Nana- Mas vocÃÂÃÂÃÂÃÂª ÃÂÃÂÃÂÃÂ© curiosa ein, e eu tambÃÂÃÂÃÂÃÂ©mÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¦ Vamos!").vai
		leticia.vai=Texto(self.__menu,"LetÃÂÃÂÃÂÃÂ­cia- Miga, vocÃÂÃÂÃÂÃÂª viu que tem algo acontecendo no Jardim? Vamos lÃÂÃÂÃÂÃÂ¡ ver?").vai
