...
class Cena1:
	def __init__(self):
  		...
  		self.__hand = Elemento(img=IMG['hand'], trt="MÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ£os", style=dict(top=200, left=125, height=100, width=70))
  		#txt = Texto(mCena, "CoÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©"
